...
##
stage : rel
	$(foreach dep,$(wildcard deps/*), rm -rf rel/koala/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/koala/lib;)
	$(foreach app,$(wildcard apps/*), rm -rf rel/koala/lib/$(shell basename $(app))-* && ln -sf $(abspath $(app)) rel/koala/lib;)
